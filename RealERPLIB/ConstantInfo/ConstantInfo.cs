...
namespace RealERPLIB.ConstantInfo
{
    public static class ConstantInfo
    {
        public async static Task<List<MenuItems>> MenuAllHR()
        {
            ...
            menuitems.Add(new MenuItems { itemcod = "0205000000", itemdesc = "02. Department Code", itemurl = "F_21_GAcc/AccSubCodeBook?InputType=Dept", fbold = "", itemslct = true, itemposition = "1st" });
